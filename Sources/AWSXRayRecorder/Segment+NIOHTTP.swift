...
public extension XRayRecorder.Segment {
    ...
    func setHTTPRequest(method: HTTPMethod, url: String, userAgent: String? = nil, clientIP: String? = nil) {
    ...
    func setHTTPRequest(_ request: HTTPRequestHead) {
    ...
    func setHTTPResponse(_ response: HTTPResponseHead) {
    ...
    /// - Parameters:
    ///   - status: HTTP  status.
    func setHTTPResponse(status: HTTPResponseStatus) {
