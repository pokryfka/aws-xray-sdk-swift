...
extension S3 {
    ...
    public func listMultipartUploadsPaginator(
        ...
        return client.paginate(input: input, command: listMultipartUploads, tokenKey: \ListMultipartUploadsOutput.nextKeyMarker, context: context, on: eventLoop, onPage: onPage)
    }
    ...
    public func listObjectVersionsPaginator(
        ...
        return client.paginate(input: input, command: listObjectVersions, tokenKey: \ListObjectVersionsOutput.nextKeyMarker, context: context, on: eventLoop, onPage: onPage)
    }
    ...
    public func listObjectsPaginator(
        ...
        return client.paginate(input: input, command: listObjects, tokenKey: \ListObjectsOutput.nextMarker, context: context, on: eventLoop, onPage: onPage)
    }
    ...
    public func listObjectsV2Paginator(
        ...
        return client.paginate(input: input, command: listObjectsV2, tokenKey: \ListObjectsV2Output.nextContinuationToken, context: context, on: eventLoop, onPage: onPage)
    }
    ...
    public func listPartsPaginator(
        ...
        return client.paginate(input: input, command: listParts, tokenKey: \ListPartsOutput.nextPartNumberMarker, context: context, on: eventLoop, onPage: onPage)
    }
